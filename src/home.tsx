...
import { MapPin, Sun, Clock, Navigation, ChevronRight, Star, Footprints, Eye, Heart, ArrowRight, Share2, RefreshCw, Sparkles, Zap, Coffee } from 'lucide-react'
  ...
  return (
    <div style={{ padding: '16px 20px 24px' }}>
      ...
      >
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ fontSize: 13, fontWeight: 600 }}>Meet Izu — the lion you'll see Saturday</div>
          </div>
        </div>
      ...
      <div className="card" style={{
        ...
        <div className="t-heading" style={{ marginBottom: 8 }}>📋 Arrival Tips</div>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 6, fontSize: 13, color: 'var(--text-secondary)' }}>
          <div>🚗 Use the Front Gate entrance — parking opens 8:30am</div>
          <div>👶 Stroller pickup at Guest Services (left of entry)</div>
          <div>☀️ Expect sun — UV index 7. Sunscreen + hats recommended</div>
          <div>📍 Start at Africa Rocks — least crowded before 10am</div>
        </div>
      </div>
    </div>
  )
